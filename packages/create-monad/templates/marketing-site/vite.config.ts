...
export default defineConfig({
  plugins: [
    monad({
      ...
      // Optional features (enabled based on CLI options):
__ENABLE_OG__      // og: { enabled: true, provider: "og-gen", mode: "per-route" },
__ENABLE_LHCI__      // lighthouse: { enabled: true, mode: "autorun" },
    }),
  ],
  build: {
